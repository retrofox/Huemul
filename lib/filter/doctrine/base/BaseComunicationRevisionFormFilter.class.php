...
/**
 * ComunicationRevision filter form base class.
 *
 * @package    Huemul
 * @subpackage filter
 ...
 */
abstract class BaseComunicationRevisionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('comunication_revision_filters[%s]');
