...
<?php endif; ?>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <th><?php echo $form['profesion_id']->renderLabel() ?></th>
        <td>
      ...
      <tr>
        <th><?php echo $form['documment_type']->renderLabel() ?></th>
        <td>
      ...
      <tr>
        <th><?php echo $form['documment']->renderLabel() ?></th>
        <td>
      ...
      <tr>
        <th><?php echo $form['addres']->renderLabel() ?></th>
        <td>
      ...
      <tr>
        <th><?php echo $form['mugshot']->renderLabel() ?></th>
        <td>
