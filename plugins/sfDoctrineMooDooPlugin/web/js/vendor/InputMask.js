...
options:
  - rules: (object, defaults to *{}*) A set of rules used for the instance of InputMask. See InputMask.Time or InputMask.Date for more information. Also see InputMask.defineRules
  - mask: (string, defaults to *null*) The mask to be used

events:
  - onKeyPress(): fires when the user presses a key
  - onError(): fires when the pressed character is not valid
...
*/
